...
3. アプリを起動すると「"PayrollCalculator.app"は開いていません」という警告が表示されます
   > 未公証アプリのための警告です。以下の手順で最初の1回だけ許可してください
...
- **カレンダー連動**: カレンダーアプリのイベントを自動読み込み（EventKit）。iCloud同期されたカレンダーに対応しているため、iPhoneのカレンダーで登録したバイトの予定も集計できます
